...
let res = 8; 
let baseZOffset = 0.0001; 
let lineColor = '#EDEDED80'; // Change this to '#00e5c080' if you want it to match your DJIANG teal!
// ----
...
function setupCanvas() {
  ...
  if (!canvasCtx) {
    console.error("Canvas context could not be loaded.");
    return;
  } else {
...
function animate() {
  ...
  // Loops perfectly at your monitor's native refresh rate
