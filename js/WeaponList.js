...
const WEAPONS = [
  // ── 6★ ──────────────────────────────────────────────────────────────────
  { id:"artzy-tyrannical",         name:"Artzy Tyrannical",         rarity:6, type:"Handcannon", base_atk:505, stat1:"Intellect +156",       stat2:"Critical Rate +19.50%",      passive:"Cryo DMG Bonus +25.60%. After the wielder scores a critical hit with a Battle Skill or Combo Skill, the wielder gains Cryo DMG dealt +22.4% for 30s. Max stacks: 3. Duration per stack counted separately. Triggers once every 0.1s.", img:"" },
  { id:"brigands-calling",         name:"Brigand's Calling",        rarity:6, type:"Handcannon", base_atk:505, stat1:"Agility +156",          stat2:"Attack +39%",                passive:"Cryo DMG Bonus +25.60%. When the wielder applies Cryo Infliction via battle skills or ultimates, the wielder gains Cryo DMG Dealt +32% for 20s. When the wielder's battle skill or ultimate applies Arts Susceptibility, target enemy suffers Arts DMG Taken +9.6% for 20s. The two effects apply separately and do not stack with themselves.", img:"" },
  ...
  { id:"clannibal",                name:"Clannibal",                rarity:6, type:"Handcannon", base_atk:490, stat1:"Main Attribute +132",   stat2:"Arts DMG Bonus +43.30%",     passive:"Arts DMG Bonus +19.20%. After the wielder consumes an Arts Reaction, target enemy suffers Arts DMG taken +16% (for the specified element) for 15s. Effect only triggers once every 25s.", img:"" },
  { id:"delivery-guaranteed",      name:"Delivery Guaranteed",      rarity:6, type:"Arts Unit",  base_atk:500, stat1:"Will +156",             stat2:"Ultimate Gain Eff. +46.40%", passive:"Nature DMG Bonus +25.60%. After the wielder applies Lifted with their own Combo Skill, the team gains Arts DMG dealt +19.2% for 15s. For every enemy Lifted, bonus Arts DMG dealt +5.6%, up to +16.8%. Effects of the same name cannot stack.", img:"" },
  { id:"detonation-unit",          name:"Detonation Unit",          rarity:6, type:"Arts Unit",  base_atk:490, stat1:"Main Attribute +132",   stat2:"Arts Intensity +78",         passive:"Sec. Attribute +16.00%. After the wielder applies an Arts Burst, target enemy suffers Arts DMG taken +14.4% for 15s. Effects of the same name cannot stack.", img:"" },
  { id:"dreams-of-the-starry-beach",name:"Dreams of the Starry Beach",rarity:6,type:"Arts Unit", base_atk:495, stat1:"Intellect +156",        stat2:"Treatment Bonus +46.40%",    passive:"Sec. Attribute +25.60%. After the wielder consumes Corrosion, target enemy suffers Arts DMG taken +16% for 25s. Effects of the same name cannot stack.", img:"" },
  { id:"eminent-repute",           name:"Eminent Repute",           rarity:6, type:"Sword",      base_atk:490, stat1:"Main Attribute +132",   stat2:"Physical DMG Bonus +43.30%", passive:"Attack +16.00%. After the wielder consumes Vulnerability stack(s), ATK +[8% + 4% x Stacks Consumed] while other Operators in the team gain half this buff for 20s. Effects of the same name cannot stack.", img:"" },
  { id:"exemplar",                 name:"Exemplar",                 rarity:6, type:"Greatsword", base_atk:500, stat1:"Main Attribute +132",   stat2:"Attack +39.00%",             passive:"Physical DMG Bonus +16.00%. After the wielder's Battle Skill or Ultimate hits the enemy, the wielder gains Physical DMG dealt +16% for 30s. Max stacks: 3. Duration per stack counted separately. Triggers once every 0.1s.", img:"" },
  ...
  { id:"forgeborn-scathe",         name:"Forgeborn Scathe",         rarity:6, type:"Sword",      base_atk:510, stat1:"Intellect +156",        stat2:"Attack +39.00%",             passive:"Heat DMG Bonus +25.60%. After the wielder casts an Ultimate, the wielder gains Basic Attack DMG dealt +120% for 20s. Effects of the same name cannot stack.", img:"" },
  ...
  { id:"glorious-memory",          name:"Glorious Memory",          rarity:6, type:"Sword",      base_atk:490, stat1:"Agility +156",          stat2:"Critical Rate +19.5%",       passive:"ATK +11.2%. When the wielder's skill applies Vulnerability, during the next ultimate cast within 30s, the wielder gains DMG Dealt +19.2%. Max stacks: 3. Duration per stack counted separately. Triggers once every 0.5s.", img:"" },
  { id:"grand-vision",             name:"Grand Vision",             rarity:6, type:"Sword",      base_atk:500, stat1:"Agility +156",          stat2:"Attack +39.00%",             passive:"Arts Intensity +48. For 20s after the wielder applies Originium Crystals or Solidification, the wielder gains Physical DMG dealt +57.6% during the next Battle Skill or Ultimate cast. Effects of the same name cannot stack.", img:"" },
  { id:"home-longing",             name:"Home Longing",             rarity:6, type:"Handcannon", base_atk:490, stat1:"Agility +156",          stat2:"Cryo DMG Dealt +43.33%",     passive:"ATK +11.2%. For 20s after the wielder casts a combo skill, the wielder's next battle skill gains Cryo and Nature DMG Dealt +12.8%. Max stacks: 2. Duration per stack counted separately.", img:"" },
  { id:"jet",                      name:"JET",                      rarity:6, type:"Polearm",    base_atk:500, stat1:"Main Attribute +132",   stat2:"Attack +39.00%",             passive:"Arts DMG Bonus +19.20%. After the wielder casts a Battle Skill, Arts DMG dealt +19.2% for 15s. After a Combo Skill, Arts DMG dealt +19.2% for 15s. The two effects apply separately and do not stack with themselves.", img:"" },
  { id:"khravengger",              name:"Khravengger",              rarity:6, type:"Greatsword", base_atk:505, stat1:"Strength +156",         stat2:"Attack +39.00%",             passive:"All Skill DMG Bonus +32.00%. When the wielder's Battle Skill applies Cryo Infliction, the wielder gains Cryo DMG dealt +16% for 15s. When the wielder deals Combo Skill DMG to an enemy with Cryo Infliction, the wielder gains Cryo DMG dealt +32% for 15s. The two effects apply separately and do not stack with themselves.", img:"" },
  { id:"lone-barge",               name:"Lone Barge",               rarity:6, type:"Arts Unit",  base_atk:510, stat1:"Will +156",             stat2:"Attack +39%",                passive:"Electric DMG Bonus +25.6%. When the wielder's battle skill consumes Arts Reactions, the wielder gains Battle Skill Electric DMG Dealt +32% for 20s. This effect can reach 2 stacks. Duration of each stack is counted separately. Triggers once every 0.1s. After the wielder casts an ultimate, the wielder gains Battle Skill Electric DMG Dealt +64% for 25s. This effect cannot stack.", img:"" },
  { id:"lupine-scarlet",           name:"Lupine Scarlet",           rarity:6, type:"Sword",      base_atk:null,stat1:"Agility +156",          stat2:"Critical Rate +19.50%",      passive:"ATK +25.60%. After the wielder's skill deals Critical DMG, gains 1 stack of Wolven Blood granting Physical and Heat DMG Dealt +1.6%. Max 16 stacks. Upon reaching 16 stacks, gains Physical and Heat DMG Dealt +38.4% for 20s, then all stacks are removed.", img:"" },
  { id:"mountain-bearer",          name:"Mountain Bearer",          rarity:6, type:"Polearm",    base_atk:500, stat1:"Agility +156",          stat2:"Physical DMG Bonus +43.30%", passive:"Against Vulnerable enemies, DMG dealt +32%. When the wielder's Battle Skill applies Vulnerability, the wielder gains All Attributes +12.8% for 15s. When the wielder's Battle Skill applies Physical Susceptibility, the wielder gains All Attributes +12.8% for 15s. The two effects apply separately and do not stack with themselves. Max stacks: 2. Duration per stack counted separately. Triggers once every 0.1s.", img:"" },
  { id:"navigator",                name:"Navigator",                rarity:6, type:"Handcannon", base_atk:490, stat1:"Intellect +156",        stat2:"Cryo DMG Bonus +43.30%",     passive:"Critical Rate +5.60%. When Solidification or Corrosion is applied to enemies, the wielder gains Cryo and Nature DMG dealt +5.6%, and Critical Rate +3.2% for 15s. If triggered by the wielder, double the increase. Effects of the same name cannot stack.", img:"" },
  { id:"never-rest",               name:"Never Rest",               rarity:6, type:"Sword",      base_atk:500, stat1:"Will +156",             stat2:"Attack +39.00%",             passive:"Physical DMG Bonus +25.60%. After the wielder recovers SP with their own skills, the wielder gains Physical DMG dealt +8% while other Operators gain Physical DMG dealt +4% for 30s. Max stacks: 5. Duration per stack counted separately. Triggers once every 0.1s.", img:"" },
  { id:"oblivion",                 name:"Oblivion",                 rarity:6, type:"Arts Unit",  base_atk:495, stat1:"Intellect +156",        stat2:"Arts DMG Bonus +43.30%",     passive:"Critical Rate +8%. After the wielder casts an Ultimate, Arts DMG dealt +38.4% for 15s. After a Combo Skill, Arts DMG dealt +19.2% for 15s. The two effects apply separately.", img:"" },
  { id:"opus-etch-figure",         name:"Opus: Etch Figure",        rarity:6, type:"Arts Unit",  base_atk:485, stat1:"Will +156",             stat2:"Nature DMG Bonus +43.30%",   passive:"ATK +11.2%. When the wielder's Battle Skill applies Nature Infliction, other Operators in the team gain Arts DMG dealt +8% for 15s. For every enemy with Nature Infliction from said Battle Skill, other Operators gain bonus Arts DMG dealt +3.2%, up to +9.6%. Effects of the same name cannot stack.", img:"" },
  ...
  { id:"sundered-prince",          name:"Sundered Prince",          rarity:6, type:"Greatsword", base_atk:490, stat1:"Strength +156",         stat2:"Critical Rate +19.50%",      passive:"After the wielder performs a Final Strike on the enemy, the wielder gains ATK +16% for 8s. If the wielder is also the Controlled Operator, double the ATK increase and deal Stagger +19.2% to the enemy. Effects of the same name cannot stack.", img:"" },
  { id:"thermite-cutter",          name:"Thermite Cutter",          rarity:6, type:"Sword",      base_atk:490, stat1:"Will +156",             stat2:"Attack +39.00%",             passive:"ATK +16%. After the wielder's skill recovers SP or grants a Link state, the entire team gains ATK +8% for 20s. Max stacks: 2. Duration per stack counted separately.", img:"" },
  { id:"thunderberge",             name:"Thunderberge",             rarity:6, type:"Greatsword", base_atk:495, stat1:"Strength +156",         stat2:"Max HP +78.00%",             passive:"Shield applied +38.4%. After the wielder's Combo Skill provides HP Treatment, the Controlled Operator gains an additional [11.2% x Wielder's Max HP] Shield for 15s. Effect triggers once every 15s.", img:"" },
  { id:"umbral-torch",             name:"Umbral Torch",             rarity:6, type:"Sword",      base_atk:490, stat1:"Intellect +156",        stat2:"Heat DMG Bonus +43.30%",     passive:"ATK +11.2%. Whenever Combustion or Corrosion is applied to an enemy, the wielder gains Heat DMG dealt and Nature DMG dealt +12.8% for 20s. Max stacks: 2. Duration per stack counted separately. Triggers once every 0.1s.", img:"" },
  { id:"valiant",                  name:"Valiant",                  rarity:6, type:"Polearm",    base_atk:495, stat1:"Agility +156",          stat2:"Physical DMG Bonus +43.30%", passive:"ATK +16%. When the wielder applies Physical Statuses, the wielder also deals another hit of Physical DMG equal to 192% of the wielder's ATK.", img:"" },
  { id:"wedge",                    name:"Wedge",                    rarity:6, type:"Handcannon", base_atk:500, stat1:"Main Attribute +132",   stat2:"Critical Rate +19.50%",      passive:"Arts DMG Dealt +19.2%. After a Battle Skill, Arts DMG dealt +12.8% for 15s. After a Battle Skill applies an Arts Reaction, Arts DMG dealt +25.6% for 15s. The two effects apply separately.", img:"" },
  { id:"white-night-nova",         name:"White Night Nova",         rarity:6, type:"Sword",      base_atk:505, stat1:"Main Attribute +132",   stat2:"Arts Intensity +78",         passive:"Arts DMG Dealt +19.2%. After the wielder applies Combustion or Electrification, the wielder gains Arts DMG dealt +19.2% and Arts Intensity +40 for 15s. Effects of the same name cannot stack.", img:"" },

  // ── 5★ ──────────────────────────────────────────────────────────────────
  { id:"ancient-canal",            name:"Ancient Canal",            rarity:5, type:"Greatsword", base_atk:411, stat1:"Strength +124",         stat2:"Arts Intensity +62",         passive:"Arts Intensity +28. After the wielder consumes Vulnerability stack(s), gains Physical DMG dealt +[14% x stacks consumed] for 20s. Effects of the same name cannot stack.", img:"" },
  { id:"aspirant",                 name:"Aspirant",                 rarity:5, type:"Sword",      base_atk:411, stat1:"Agility +124",          stat2:"Physical DMG Bonus +34.70%", passive:"Ultimate DMG Bonus +44.80%. For 30s after the wielder applies Lifted, gains Physical DMG dealt +33.6% during the next Ultimate cast. Max stacks: 3. Duration per stack counted separately. Triggers once every 0.5s.", img:"" },
  { id:"chimeric-justice",         name:"Chimeric Justice",         rarity:5, type:"Polearm",    base_atk:411, stat1:"Strength +124",         stat2:"Ultimate Gain Eff. +37.10%", passive:"Critical Rate +8.40%. After the wielder applies Vulnerability to an enemy with no Vulnerability stacks, ATK +42% for 15s. Effects of the same name cannot stack.", img:"" },
  { id:"cohesive-traction",        name:"Cohesive Traction",        rarity:5, type:"Polearm",    base_atk:411, stat1:"Will +124",             stat2:"Electric DMG Bonus +34.70%", passive:"Combo Skill DMG Bonus +28.00%. For 30s after the wielder casts a Combo Skill, gains Electric DMG dealt +28% during the next Battle Skill cast. Max stacks: 3. Duration per stack counted separately.", img:"" },
  { id:"finchaser-3",              name:"Finchaser 3.0",            rarity:5, type:"Sword",      base_atk:411, stat1:"Strength +124",         stat2:"Cryo DMG Bonus +34.70%",     passive:"Attack +14.00%. After the wielder's Battle Skill applies Solidification, target enemy suffers Cryo DMG taken +19.6% for 15s.", img:"" },
  { id:"finishing-call",           name:"Finishing Call",           rarity:5, type:"Greatsword", base_atk:411, stat1:"Strength +124",         stat2:"Max HP +62.40%",             passive:"Sec. Attribute +14.00%. Combo Skill HP Treatment effect +56%.", img:"" },
  { id:"fortmaker",                name:"Fortmaker",                rarity:5, type:"Sword",      base_atk:411, stat1:"Intellect +124",        stat2:"Ultimate Gain Eff. +37.10%", passive:"Attack +14.00%. Arts Intensity +70.", img:"" },
  { id:"freedom-to-proselytize",   name:"Freedom to Proselytize",   rarity:5, type:"Arts Unit",  base_atk:411, stat1:"Will +124",             stat2:"Treatment Bonus +37.10%",    passive:"Main Attribute +14.00%. When the wielder restores HP with their own Battle Skill, the Controlled Operator is restored for another [168 + Will x 1.4]. Triggers once every 15s.", img:"" },
  { id:"monaihe",                  name:"Monaihe",                  rarity:5, type:"Arts Unit",  base_atk:411, stat1:"Will +124",             stat2:"Ultimate Gain Eff. +37.10%", passive:"Main Attribute +14.00%. Arts Intensity +70.", img:"" },
  { id:"obj-arts-identifier",      name:"OBJ Arts Identifier",      rarity:5, type:"Arts Unit",  base_atk:411, stat1:"Intellect +124",        stat2:"Arts Intensity +62",         passive:"Max HP +28.00%. After the wielder applies Arts Burst or Physical Status with their own Combo Skill, the entire team gains Heat DMG dealt and Electric DMG dealt +22.4% for 15s. Effects of the same name cannot stack.", img:"" },
  { id:"obj-edge-of-lightness",    name:"OBJ Edge of Lightness",    rarity:5, type:"Sword",      base_atk:411, stat1:"Agility +124",          stat2:"Attack +31.20%",             passive:"Sec. Attribute +14.00%. After the wielder recovers SP by their own skill, the entire team gains Heat DMG dealt and Electric DMG dealt +8.4% for 20s. Max stacks: 3. Duration per stack counted separately.", img:"" },
  { id:"obj-heavy-burden",         name:"OBJ Heavy Burden",         rarity:5, type:"Greatsword", base_atk:411, stat1:"Strength +124",         stat2:"Max HP +62.40%",             passive:"Sec. Attribute +14.00%. After the wielder applies Knocked Down or Weakened, DEF +50.4% for 15s. Effects of the same name cannot stack.", img:"" },
  { id:"obj-razorhorn",             name:"OBJ Razorhorn",             rarity:5, type:"Polearm",    base_atk:411, stat1:"Will +124",             stat2:"Physical DMG Bonus +34.70%", passive:"To enemies with Cryo Infliction or Solidification, the wielder gains DMG Dealt +22.4%. After consuming Solidification, ATK +33.6% for 15s. Effects of the same name cannot stack.", img:"" },
  { id:"obj-velocitous",           name:"OBJ Velocitous",           rarity:5, type:"Handcannon", base_atk:411, stat1:"Agility +124",          stat2:"Ultimate Gain Eff. +37.10%", passive:"ATK +14%. After the wielder consumes an Arts Infliction, gains Nature DMG dealt +[14% x Stacks Consumed] for 20s. Effects of the same name cannot stack.", img:"" },
  { id:"opus-the-living",          name:"Opus: The Living",         rarity:5, type:"Handcannon", base_atk:411, stat1:"Agility +124",          stat2:"Arts DMG Bonus +34.70%",     passive:"Critical Rate +8.4%. After the wielder applies an Arts Reaction, ATK +21% for 20s. Max stacks: 2. Duration per stack counted separately. Triggers once every 0.1s.", img:"" },
  { id:"rational-farewell",        name:"Rational Farewell",        rarity:5, type:"Handcannon", base_atk:411, stat1:"Strength +124",         stat2:"Heat DMG Bonus +34.70%",     passive:"Battle Skill DMG +28%. After the wielder's combo skill applies Arts Burst or Combusted, ATK +44.8% for 15s. Effects of the same name cannot stack.", img:"" },
  { id:"seeker-of-dark-lung",      name:"Seeker of Dark Lung",      rarity:5, type:"Greatsword", base_atk:411, stat1:"Strength +124",         stat2:"Ultimate Gain Eff. +37.10%", passive:"Main Attribute +14%. After the wielder applies an Arts Burst, ATK +16.8% for 30s. Max stacks: 3. Duration per stack counted separately. Triggers once every 0.1s.", img:"" },
  { id:"stanza-of-memorials",      name:"Stanza of Memorials",      rarity:5, type:"Arts Unit",  base_atk:411, stat1:"Intellect +124",        stat2:"Attack +31.20%",             passive:"Max HP +28%. After the wielder casts an Ultimate, Operators whose elements differ from the wielder gain ATK +22.4% for 20s. Effects of the same name cannot stack.", img:"" },
  { id:"sundering-steel",          name:"Sundering Steel",          rarity:5, type:"Sword",      base_atk:411, stat1:"Agility +124",          stat2:"Physical DMG Bonus +34.70%", passive:"ATK +14%. After the wielder deals a Physical Status, ATK +21% for 20s. Max stacks: 2. Duration per stack counted separately. Triggers once every 0.1s.", img:"" },
  { id:"twelve-questions",         name:"Twelve Questions",         rarity:5, type:"Sword",      base_atk:411, stat1:"Agility +124",          stat2:"Attack +31.20%",             passive:"Sec. Attribute +14%. After the wielder consumes an Arts Reaction, ATK +21% for 20s. Max stacks: 2. Duration per stack counted separately.", img:"" },
  { id:"wild-wanderer",            name:"Wild Wanderer",            rarity:5, type:"Arts Unit",  base_atk:411, stat1:"Intellect +124",        stat2:"Electric DMG Bonus +34.70%", passive:"Arts Intensity +28. After the wielder applies Electrification, the team gains Physical DMG dealt and Electric DMG dealt +22.4% for 15s. Effects of the same name cannot stack.", img:"" },
